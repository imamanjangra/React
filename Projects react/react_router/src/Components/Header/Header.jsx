            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div
                        ...
                        id="mobile-menu-2"
                    >
                        <ul className="flex flex-col mt-4 mr-10 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                to='/'
                                    className={({isActive}) =>
                        ...
                        <ul className="flex flex-col mt-4 ml-10 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                to='/contact'
                                    className={({isActive}) =>
